...
AlbumData albumFromJson(String str) => AlbumData.fromJson(json.decode(str));

String albumToJson(AlbumData data) => json.encode(data.toJson());
...
class Body {
  ...
  List<albumList> trackList;

  factory Body.fromJson(Map<String, dynamic> json) => Body(
    trackList: List<albumList>.from(json["track_list"].map((x) => albumList.fromJson(x))),
  );
...
class albumList {
  ...
  factory albumList.fromJson(Map<String, dynamic> json) => albumList(
    track: Album.fromJson(json["track"]),
  );
...
class Album {
  ...
  int trackId;
  String trackName;
  List<AlbumNameTranslationList> trackNameTranslationList;
  int trackRating;
  int commontrackId;
  int instrumental;
  int explicit;
  ...
  factory Album.fromJson(Map<String, dynamic> json) => Album(
    ...
    trackNameTranslationList: List<AlbumNameTranslationList>.from(json["track_name_translation_list"].map((x) => AlbumNameTranslationList.fromJson(x))),
...
class AlbumNameTranslationList {
  AlbumNameTranslationList({
    required this.trackNameTranslation,
  });

  TrackNameTranslation trackNameTranslation;

  factory AlbumNameTranslationList.fromJson(Map<String, dynamic> json) => AlbumNameTranslationList(
